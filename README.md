...
An [Ansible](http://www.ansible.com/home) provisioner for [AngularJS](http://angularjs.org) and [Chinook](https://github.com/fregelab/chinook).

This provisioner installs the [Angular-Chinook generator](https://github.com/rayokota/generator-angular-chinook) and all prerequisites.  Currently it only supports Ubuntu 12.04.
